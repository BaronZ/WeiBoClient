...
public class HttpConfig {
    ...
    //连接超时时间10秒
    public static final long CONNECTION_TIMEOUT_IN_SECOND = 30;
    public static final long READ_TIMEOUT_IN_SECOND = 30;
    public static final long WRITE_TIMEOUT_IN_SECOND = 30;
}
